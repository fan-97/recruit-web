  ...
  <div class="container">
    <div class="hrForm">
      ...
      >
        ...
        <el-form-item prop="code">
          <el-input
            v-model="hrInfo.code"
            style="width: 270px;padding-right: 10px;"
            placeholder="验证码"
          ></el-input>
      ...
      <div class="introduceCompany">
        ...
        <p>
          Job-hunting and recruitment oriented to the Internet,
          providing more internship and job opportunities
          From now on, thumb up your life, start with this job.
        </p>
      </div>
    ...
    <el-dialog title="公司信息" :visible.sync="dialogShow">
      <el-form :model="companyInfo" class="companyForm">
        ...
        <el-form-item :label-width="formLabelWidth" label="公司LOGO">
          <el-upload
            class="avatar-uploader"
            action="/api/v1/company/upload"
            :show-file-list="false"
            :on-success="handleAvatarSuccess"
            :before-upload="beforeAvatarUpload"
          >
            <img v-if="companyInfo.avatar" :src="getImage(companyInfo.avatar)" class="avatar" />
...
<script>
/* eslint-disable indent,quotes,space-before-function-paren,brace-style */
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      if (res.code == "000000") {
        ...
        this.companyInfo.avatar = res.data;
      } else {
        this.$message({
          message: res.msg,
          type: "error"
